...
export default async function AuthPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_10%_20%,_#d9f2ff,_transparent_40%),radial-gradient(circle_at_90%_10%,_#fce4cf,_transparent_35%),#f4f7fb] px-4 py-10">
